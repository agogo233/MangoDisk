...
const dynamicKeyGroups = {
  ...
  'privacy.categories': ['browserActivity', 'browserAccountState', 'applicationActivity', 'systemActivity'],
  'privacy.categoryDescriptions': ['browserActivity', 'browserAccountState', 'applicationActivity', 'systemActivity'],
  'privacy.kinds': [
    'browsingHistory',
    'downloadHistory',
    'cookies',
  ...
  'privacy.impacts': ['low', 'workflow', 'signOut', 'crossDevice', 'dataLoss', 'unknown'],
  'privacy.result.statuses': ['cleared', 'unchanged', 'failed', 'cancelled'],
  'history.categories': [
    'deepCleanup',
    'largeFileCleanup',
  ...
  'history.privacyStatuses': ['cleared', 'unchanged', 'failed', 'cancelled'],
