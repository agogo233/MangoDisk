export const EVENT_NAMES = {
  ...
  privacyScanProgress: 'privacy-scan-progress',
  privacyExecutionProgress: 'privacy-execution-progress',
...
export const LOG_EVENTS = {
  ...
  largeFilePreferencesInvalid: 'preferences_invalid',
  largeFilePreferencesLoadFailed: 'preferences_load_failed',
  largeFilePreferencesSaveFailed: 'preferences_save_failed',
  largeFileExclusionsUpdated: 'exclusions_updated',
  ...
  startupChangeBatchDispatched: 'startup_change_batch_dispatched',
  ...
  privacyScanRequested: 'scan_requested',
  privacyScanCompleted: 'scan_completed',
  privacyScanFailed: 'scan_failed',
  privacyBrowserStatusRefreshFailed: 'browser_status_refresh_failed',
  privacyBrowserStatusRefreshRecovered: 'browser_status_refresh_recovered',
  privacyExecutionRequested: 'execution_requested',
  privacyExecutionCompleted: 'execution_completed',
  privacyExecutionFailed: 'execution_failed',
